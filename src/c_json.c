...
//		printf("sub1obj err\n");
	...
	else
	{
		if((strlen(json_object_to_json_string(sub1obj)) + 1) > len)
		{
			...
			strncpy(tmp_str, json_object_to_json_string(sub1obj), strlen(json_object_to_json_string(sub1obj)) + 1);
#if 0
...
int __json_key_to_int(struct json_object *new_obj, char *key)
{
	int val=0;
